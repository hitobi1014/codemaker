...
<link href="/css/admin/teacher/listResume.css" rel="stylesheet" />
<title>이력서조회</title>
<div class="card shadow">
	<div class="card-header border-0">
		...
		<h1 class="mb-0 fw-600">이력서 조회</h1>
	</div>
	<div class="table-responsive">
		...
		<form action="${goResumeList }" method="post" id="resumeForm">
			...
			<table class="table align-items-center table-flush resume-tb fw-600">
				<tr>
					<th>아이디</th>
					<th>승인코드</th>
					<th>이름</th>
