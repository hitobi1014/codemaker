...
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/animate.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/bootstrap.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/animsition.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/daterangepicker.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/font-awesome.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/hamburgers.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/icon-font.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css" href="/css/admin/login/main.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="/css/admin/login/select2.min.css">
<!--===============================================================================================-->
...
$(function(){
	$("#teacherImg").click(function(){
		...
		$("#adminImg").attr("src", "/images/admin/signup/admin (1).png");
	})
	$("#adminImg").click(function(){
		$("#teacherImg").attr("src", "/images/admin/signup/teacher (1).png");
		$(this).attr("src", "/images/admin/signup/admin.png");
	})
})
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w">
					<span class="login100-form-title p-b-51"> Login </span> <img
						id="teacherImg" alt="교사"
						src="/images/admin/signup/teacher (1).png"
						style="height: 120px; width: 120px;"> <img id="adminImg"
						alt="관리자" src="/images/admin/signup/admin (1).png"
					...
					<div class="searchuser">
						<a href="" id="findIdPass" class=""
							data-tiara-action-name="아이디/비밀번호찾기_링크">ID/비밀번호 찾기</a> <span
							class="txt_bar">|</span>
						<!-- Trigger the modal with a button -->
						<a href="#myModal" data-toggle="modal" id="findID" class=""
							data-tiara-action-name="회원가입_링크">회원가입</a>
					</div>
				</form>
			</div>
		</div>
...
>>>>>>> VO수정
					...
					<button
						class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding">가입</button>
