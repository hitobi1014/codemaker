	...
	<div id="sidebar" class="sidebar sidebar-with-footer">
		...
		<div class="app-brand">
			...
			<a href="${mainAdmin }">
				...
				<span class="brand-name" style="color: #b7c0cd;">관리자</span>
			</a>
		</div>
			...
			<ul class="nav sidebar-inner" id="sidebar-menu">
				<li class="has-sub">
					...
					<ul class="collapse" id="ui-elements" data-parent="#sidebar-menu">
						<div class="sub-menu">
							<li  class="has-sub" >
								<a class="sidenav-item-link" data-toggle="collapse" data-target="#components" aria-expanded="false" aria-controls="components">
