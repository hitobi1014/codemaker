...
<div>
	<button type="button" id="submitBtn" class="button button-primary button-small form-control-label" data-comid="${companyVO.comId}">제출</button>
</div>
</div>	
...
// 			}
// 	})
			document.location="/pdfTest?comId="+comId+"&allText="+allText;
