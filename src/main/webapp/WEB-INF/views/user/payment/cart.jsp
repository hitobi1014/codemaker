...
<div class="cart-box">
	<div class="cartBoxArea">
		<c:choose>
			<c:when test="${fn:length(lessonList) !=0}">
				<h3>강의 장바구니</h3>
				<table>
					<thead id="thead">
						<tr>
							...
							<c:forEach items="${lessonList}" var="lesson" varStatus="stat">
								...
								<tr class="lessonTr">
									...
									<td class="tdLine tdCenter">
										<div>
											<span style="font-weight: 600;">${lesson.tchNm}</span>
										</div>
									</td>
									<td class="tdLine tdCenter">
										<div class="tdinDiv">
			...
			<c:otherwise>
				<div class="empty-cart">
					<div>
						<span>담은 강의 내역이 없습니다</span>
						<div style="text-align: center;"><button class="les-list" id="leslistBtn">강의목록으로</button></div>
					</div>
				</div>
			</c:otherwise>
		</c:choose>
...
$(function(){
	...
	$("#leslistBtn").click(function(){
		console.log("여기");
		location.href="/user/selectSubject";
	})
