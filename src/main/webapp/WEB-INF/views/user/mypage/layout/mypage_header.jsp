...
=======
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-white-600 middle">OO님!</span> <img
				id="navicon" class="img-profile rounded-circle"
			...
			<div
				...
				<<<<<<< HEAD <a class="dropdown-item" href="#" data-toggle="modal"
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			aria-haspopup="true" aria-expanded="false">&emsp;&emsp;&emsp;&emsp;&emsp;
		</a></li>
		<li class="nav-item dropdown no-arrow mx-1"><a
			class="nav-link dropdown-toggle" href="#" id="space" role="button"
