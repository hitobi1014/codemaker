...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <link href="/vendor/user/main/ontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <button class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <li class="nav-item">
                <button class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <button class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
