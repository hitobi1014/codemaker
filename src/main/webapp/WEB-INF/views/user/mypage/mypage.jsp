        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background:#005F86">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img id="usericon" src="/images/user/icons/user.png">
                <br>
                <br>
                OO님
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons.html">◾ 정보조회</a>
                        <a class="collapse-item" href="cards.html">◾ 회원탈퇴</a>
                        <a class="collapse-item" href="cards.html">◾ 포인트</a>
                        <a class="collapse-item" href="cards.html">◾ 쿠폰함</a>
