				...
				<td>
					<div>
						...
						<div style="float: left; width: 50%;">
							...
							<input id="upBtn" class="upClass button button-inline button-small button-primary form-control-label" type="button" value="수정" id="upBtn">
						</div>
					</div>
				</td>
			</c:when>
			<c:when test="${no.lesState=='2' }">
				<td>
					<div>
						...
						<div style="float: left; width: 50%;">
							<input id="delBtn" class="delClass button button-inline button-small button-danger form-control-label" type="button" value="삭제" data-lesId="${no.lesId}" onclick="delLes()">
							<input id="upBtn" class="button button-inline button-small button-primary form-control-label" type="button" value="수정" id="upBtn">
						</div>
					</div>
				</td>
			</c:when>
