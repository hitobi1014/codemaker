						...
						<div class="sub-menu">
							...
							<li class="has-sub"><a class="sidenav-item-link" href="#"
								...
								aria-expanded="false" aria-controls="components"> <span
									class="nav-text">수강 관리</span> <b class="caret"></b>
							</a>
								<ul class="collapse" id="components">
									<div class="sub-menu">

										<li><a href="#">강의 개설 및 수정</a></li>

										<li><a href="#">교재파일 등록 및 수정/삭제</a></li>

										<li><a href="#">커리큘럼 임시저장소</a></li>
							...
							<li class="has-sub"><a class="sidenav-item-link" href="#"
								...
								aria-expanded="false" aria-controls="icons"> <span
									class="nav-text">과목별 게시판</span> <b class="caret"></b>
							</a>
								<ul class="collapse" id="icons">
									<div class="sub-menu">

										<li><a href="#">질문 응답 게시판</a></li>
